...
namespace CompleteUtterGarbage.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,ZipCodeRoute")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,ZipCodeRoute")] Employee employee)
        {
            if (ModelState.IsValid)
            {
